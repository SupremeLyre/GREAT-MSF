...
t_gcoder::t_gcoder(t_gsetbase *s, string version, int sz, string id)
    : _class(id), _initialized(false), _gnss(true), _initver(version), _close_with_warning(true)
{
    _init();
...
t_gcoder::t_gcoder(t_gtime beg, t_gtime end, t_gsetbase *s, string version, int sz, string id)
    : _class(id), _initialized(false), _gnss(true), _initver(version), _close_with_warning(true), beg_epoch(beg),
      end_epoch(end)
{
    _init();
...
t_gcoder::t_gcoder(t_gsetbase *s, int sz) : _initialized(false), _gnss(false), _close_with_warning(true)
{
    _init();
