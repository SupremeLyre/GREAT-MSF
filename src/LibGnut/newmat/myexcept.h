...
inline Tracer::Tracer(const char *e) : entry(e), previous(last)
{
    last = this;
}
...
inline void Tracer::ReName(const char *e)
{
    entry = e;
}
...
inline void Throw(const BaseException &)
{
    Throw();
}
...
#define MONITOR_REAL_NEW(Operation, Size, Pointer) FreeCheck::RegisterR(Pointer, Operation, Size);
#define MONITOR_INT_NEW(Operation, Size, Pointer) FreeCheck::RegisterI(Pointer, Operation, Size);
#define MONITOR_REAL_DELETE(Operation, Size, Pointer) FreeCheck::DeRegisterR(Pointer, Operation, Size);
#define MONITOR_INT_DELETE(Operation, Size, Pointer) FreeCheck::DeRegisterI(Pointer, Operation, Size);
