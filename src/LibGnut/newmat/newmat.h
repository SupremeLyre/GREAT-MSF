...
class LibGnut_LIBRARY_EXPORT MatrixType
{
  ...
  public:
    ...
    MatrixType(const MatrixType &mt) : attribute(mt.attribute), DataLossOK(mt.DataLossOK)
    {
    }
...
class LibGnut_LIBRARY_EXPORT MatrixBandWidth
{
  public:
    ...
    {
        return MatrixBandWidth(upper_val, lower_val);
    }
...
class LibGnut_LIBRARY_EXPORT GeneralMatrix : public BaseMatrix // declarable matrix types
{
  ...
  public:
    ...
    {
        return is_zero();
    } // test matrix has all zeros
    void Release()
    {
        tag_val = 1;
    } // del store after next use
    void Release(int t)
    {
        tag_val = t;
    } // del store after t accesses
    void ReleaseAndDelete()
    {
        tag_val = 0;
    } // delete matrix after use
    void release()
    {
        tag_val = 1;
    } // del store after next use
    ...
    void Inject(const GeneralMatrix &GM_A)
    {
        inject(GM_A);
    }
...
class LibGnut_LIBRARY_EXPORT SquareMatrix : public Matrix
{
  ...
  public:
    ...
    void operator=(const Matrix &m);
    MatrixType type() const;
    SquareMatrix(const SquareMatrix &gm) : Matrix()
    {
        GetMatrix(&gm);
    }
...
class LibGnut_LIBRARY_EXPORT LowerTriangularMatrix : public GeneralMatrix
{
  ...
  public:
    ...
    LowerTriangularMatrix(const LowerTriangularMatrix &gm) : GeneralMatrix()
    {
        GetMatrix(&gm);
    }
...
class LibGnut_LIBRARY_EXPORT DiagonalMatrix : public GeneralMatrix
{
  ...
  public:
    ...
    DiagonalMatrix(const DiagonalMatrix &gm) : GeneralMatrix()
    {
        GetMatrix(&gm);
    }
    void operator=(const BaseMatrix &);
...
class LibGnut_LIBRARY_EXPORT RowVector : public Matrix
{
  ...
  public:
    ...
    RowVector(const RowVector &gm) : Matrix()
    {
        GetMatrix(&gm);
    }
    void operator=(const BaseMatrix &);
...
class LibGnut_LIBRARY_EXPORT ColumnVector : public Matrix
{
  ...
  public:
    ...
    ColumnVector(const ColumnVector &gm) : Matrix()
    {
        GetMatrix(&gm);
    }
    void operator=(const BaseMatrix &);
...
class LibGnut_LIBRARY_EXPORT BandLUMatrix : public GeneralMatrix
{
  ...
  public:
    ...
    BandLUMatrix() : indx(0), d(true), sing(true), store2(0), storage2(0), m1(0), m2(0)
    {
    }
...
class LibGnut_LIBRARY_EXPORT MultipliedMatrix : public BaseMatrix
{
  protected:
    ...
    MultipliedMatrix(const BaseMatrix *bm1x, const BaseMatrix *bm2x) : bm1(bm1x), bm2(bm2x)
    {
    }
    int search(const BaseMatrix *) const;
    friend class BaseMatrix;
...
{
  protected:
    AddedMatrix(const BaseMatrix *bm1x, const BaseMatrix *bm2x) : MultipliedMatrix(bm1x, bm2x)
    {
    }
...
{
  protected:
    SPMatrix(const BaseMatrix *bm1x, const BaseMatrix *bm2x) : AddedMatrix(bm1x, bm2x)
    {
    }
...
{
  protected:
    KPMatrix(const BaseMatrix *bm1x, const BaseMatrix *bm2x) : MultipliedMatrix(bm1x, bm2x)
    {
    }
...
{
  protected:
    ConcatenatedMatrix(const BaseMatrix *bm1x, const BaseMatrix *bm2x) : MultipliedMatrix(bm1x, bm2x)
    {
    }
...
{
  protected:
    StackedMatrix(const BaseMatrix *bm1x, const BaseMatrix *bm2x) : ConcatenatedMatrix(bm1x, bm2x)
    {
    }
...
{
    SolvedMatrix(const BaseMatrix *bm1x, const BaseMatrix *bm2x) : MultipliedMatrix(bm1x, bm2x)
    {
    }
    friend class BaseMatrix;
...
{
    SubtractedMatrix(const BaseMatrix *bm1x, const BaseMatrix *bm2x) : AddedMatrix(bm1x, bm2x)
    {
    }
    friend class BaseMatrix;
    friend class GeneralMatrix;
...
{
    int nr, nc;
    MatedMatrix(const BaseMatrix *bmx, int nrx, int ncx) : NegatedMatrix(bmx), nr(nrx), nc(ncx)
    {
    }
    friend class BaseMatrix;
...
class LibGnut_LIBRARY_EXPORT GetSubMatrix : public NegatedMatrix
{
    ...
    GetSubMatrix(const BaseMatrix *bmx, int rs, int rn, int cs, int cn, bool is)
        : NegatedMatrix(bmx), row_skip(rs), row_number(rn), col_skip(cs), col_number(cn), IsSym(is)
    {
    }
    void SetUpLHS();
    friend class BaseMatrix;
  ...
  public:
    GetSubMatrix(const GetSubMatrix &g)
        : NegatedMatrix(g.bm), row_skip(g.row_skip), row_number(g.row_number), col_skip(g.col_skip),
          col_number(g.col_number), IsSym(g.IsSym)
    {
    }
    ~GetSubMatrix()
    {
...
LibGnut_LIBRARY_EXPORT inline bool IsZero(const BaseMatrix &A)
{
    return is_zero(A);
}
...
LibGnut_LIBRARY_EXPORT inline Real sum_square(const BaseMatrix &B)
{
    return B.sum_square();
}
LibGnut_LIBRARY_EXPORT inline Real SumSquare(const BaseMatrix &B)
{
    return B.sum_square();
}
LibGnut_LIBRARY_EXPORT inline Real norm_Frobenius(const BaseMatrix &B)
{
    return B.norm_Frobenius();
}
LibGnut_LIBRARY_EXPORT inline Real norm_frobenius(const BaseMatrix &B)
{
    return B.norm_Frobenius();
}
LibGnut_LIBRARY_EXPORT inline Real NormFrobenius(const BaseMatrix &B)
{
    return B.norm_Frobenius();
}
LibGnut_LIBRARY_EXPORT inline Real trace(const BaseMatrix &B)
{
    return B.trace();
}
LibGnut_LIBRARY_EXPORT inline Real Trace(const BaseMatrix &B)
...
LibGnut_LIBRARY_EXPORT inline Real maximum(const BaseMatrix &B)
{
    return B.maximum();
}
LibGnut_LIBRARY_EXPORT inline Real Maximum(const BaseMatrix &B)
...
LibGnut_LIBRARY_EXPORT inline Real minimum(const BaseMatrix &B)
{
    return B.minimum();
}
LibGnut_LIBRARY_EXPORT inline Real Minimum(const BaseMatrix &B)
...
LibGnut_LIBRARY_EXPORT inline Real norm1(const BaseMatrix &B)
{
    return B.norm1();
}
LibGnut_LIBRARY_EXPORT inline Real Norm1(const BaseMatrix &B)
...
LibGnut_LIBRARY_EXPORT inline Real norm1(RowVector &RV)
{
    return RV.maximum_absolute_value();
}
LibGnut_LIBRARY_EXPORT inline Real Norm1(RowVector &RV)
{
    return RV.maximum_absolute_value();
}
LibGnut_LIBRARY_EXPORT inline Real norm_infinity(const BaseMatrix &B)
{
    return B.norm_infinity();
}
LibGnut_LIBRARY_EXPORT inline Real NormInfinity(const BaseMatrix &B)
{
    return B.norm_infinity();
}
...
LibGnut_LIBRARY_EXPORT inline bool IsZero(const GeneralMatrix &A)
{
    return A.IsZero();
}
LibGnut_LIBRARY_EXPORT inline bool is_zero(const GeneralMatrix &A)
{
    return A.is_zero();
}

LibGnut_LIBRARY_EXPORT inline MatrixInput MatrixInput::operator<<(int f)
{
    return *this << (Real)f;
}
LibGnut_LIBRARY_EXPORT inline MatrixInput GeneralMatrix::operator<<(int f)
{
    return *this << (Real)f;
}
LibGnut_LIBRARY_EXPORT inline MatrixInput BandMatrix::operator<<(int f)
{
    return *this << (Real)f;
}
LibGnut_LIBRARY_EXPORT inline MatrixInput GetSubMatrix::operator<<(int f)
{
    return *this << (Real)f;
}
LibGnut_LIBRARY_EXPORT inline ReversedMatrix BaseMatrix::Reverse() const
{
    return reverse();
}
LibGnut_LIBRARY_EXPORT inline RowedMatrix BaseMatrix::AsRow() const
{
    return as_row();
}
LibGnut_LIBRARY_EXPORT inline ColedMatrix BaseMatrix::AsColumn() const
{
    return as_column();
}
LibGnut_LIBRARY_EXPORT inline DiagedMatrix BaseMatrix::AsDiagonal() const
{
    return as_diagonal();
}
...
LibGnut_LIBRARY_EXPORT inline GetSubMatrix BaseMatrix::Row(int f) const
{
    return row(f);
}
LibGnut_LIBRARY_EXPORT inline GetSubMatrix BaseMatrix::Rows(int f, int l) const
{
    return rows(f, l);
}
LibGnut_LIBRARY_EXPORT inline GetSubMatrix BaseMatrix::Column(int f) const
{
    return column(f);
}
...
LibGnut_LIBRARY_EXPORT inline Real BaseMatrix::AsScalar() const
{
    return as_scalar();
}

LibGnut_LIBRARY_EXPORT inline ReturnMatrix GeneralMatrix::ForReturn() const
{
    return for_return();
}

LibGnut_LIBRARY_EXPORT inline void swap(Matrix &A, Matrix &B)
{
    A.swap(B);
}
LibGnut_LIBRARY_EXPORT inline void swap(SquareMatrix &A, SquareMatrix &B)
{
    A.swap(B);
}
LibGnut_LIBRARY_EXPORT inline void swap(nricMatrix &A, nricMatrix &B)
{
    A.swap(B);
}
...
LibGnut_LIBRARY_EXPORT inline void swap(SymmetricMatrix &A, SymmetricMatrix &B)
{
    A.swap(B);
}
LibGnut_LIBRARY_EXPORT inline void swap(DiagonalMatrix &A, DiagonalMatrix &B)
{
    A.swap(B);
}
LibGnut_LIBRARY_EXPORT inline void swap(RowVector &A, RowVector &B)
{
    A.swap(B);
}
LibGnut_LIBRARY_EXPORT inline void swap(ColumnVector &A, ColumnVector &B)
{
    A.swap(B);
}
LibGnut_LIBRARY_EXPORT inline void swap(CroutMatrix &A, CroutMatrix &B)
{
    A.swap(B);
}
LibGnut_LIBRARY_EXPORT inline void swap(BandMatrix &A, BandMatrix &B)
{
    A.swap(B);
}
LibGnut_LIBRARY_EXPORT inline void swap(UpperBandMatrix &A, UpperBandMatrix &B)
{
    A.swap(B);
}
LibGnut_LIBRARY_EXPORT inline void swap(LowerBandMatrix &A, LowerBandMatrix &B)
{
    A.swap(B);
}
LibGnut_LIBRARY_EXPORT inline void swap(SymmetricBandMatrix &A, SymmetricBandMatrix &B)
{
    A.swap(B);
}
LibGnut_LIBRARY_EXPORT inline void swap(BandLUMatrix &A, BandLUMatrix &B)
{
    A.swap(B);
}
LibGnut_LIBRARY_EXPORT inline void swap(IdentityMatrix &A, IdentityMatrix &B)
{
    A.swap(B);
}
LibGnut_LIBRARY_EXPORT inline void swap(GenericMatrix &A, GenericMatrix &B)
{
    A.swap(B);
}
