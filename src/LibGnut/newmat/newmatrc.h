...
inline MatrixCol::MatrixCol(GeneralMatrix *gmx, Real *r, LoadAndStoreFlag cwx, int col)
{
    gm = gmx;
    data = r;
    cw = cwx + StoreHere;
...
inline MatrixColX::MatrixColX(GeneralMatrix *gmx, Real *r, LoadAndStoreFlag cwx, int col)
{
    gm = gmx;
    store = data = r;
    cw = cwx + StoreHere;
...
inline void MatrixCol::Next()
{
    gm->NextCol(*this);
}

inline void MatrixColX::Next()
{
    gm->NextCol(*this);
}
