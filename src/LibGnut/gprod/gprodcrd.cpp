...
t_gprodcrd::t_gprodcrd(const t_gtime &t, shared_ptr<t_gobj> pt) : t_gprod(t, pt)
{
    id_type(POS);
    id_group(GRP_PRODUCT);
}

t_gprodcrd::t_gprodcrd(t_spdlog spdlog, const t_gtime &t, shared_ptr<t_gobj> pt) : t_gprod(spdlog, t, pt)
{
