...
class LibGnut_LIBRARY_EXPORT t_gflt
{
  public:
     ...
     * @return void
     */
    virtual void update(const Matrix &A, const DiagonalMatrix &P, const ColumnVector &l, ColumnVector &dx,
                        SymmetricMatrix &Q){};
     ...
     * @return void
     */
    virtual void update(const Matrix &A, const SymmetricMatrix &P, const ColumnVector &l, ColumnVector &dx,
                        SymmetricMatrix &Q){};
     ...
     * @return void
     */
    virtual void add_data(const t_gallpar &param, const ColumnVector &dx, const SymmetricMatrix &Qx,
                          const double &sigma0, const SymmetricMatrix &Qx0);
     ...
     * @return void
     */
    virtual bool outlierDetect(const Matrix &A, const SymmetricMatrix &Q, const ColumnVector &dx, const ColumnVector &l,
                               SymmetricMatrix &P);
