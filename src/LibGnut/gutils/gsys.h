...
#define R01_F(a)                                                                                                       \
    R01_MLT *GLO_FRQ + R01_STEP *(a) ///<  G1    - GLONASS (FDMA) base frequency  L1 = 1602 MHz + (n x 0.5625) MHz
#define R02_F(a)                                                                                                       \
    R02_MLT *GLO_FRQ + R02_STEP *(a) ///<  G2    - GLONASS (FDMA) base frequency  L2 = 1246 MHz + (n x 0.4375) MHz
