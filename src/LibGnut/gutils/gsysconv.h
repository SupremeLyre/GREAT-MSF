...
LibGnut_LIBRARY_EXPORT int rao2xyz(const ColumnVector &pos, const ColumnVector &vel, const ColumnVector &rao,
                                   ColumnVector &xyz);

/**@brief XYZ coordinates to Radial/Along-track/Out-of-plane (Satell-system) */
LibGnut_LIBRARY_EXPORT int xyz2rao(const ColumnVector &pos, const ColumnVector &vel, ColumnVector &xyz,
                                   ColumnVector &rao);
