...
t_map_sats GNSS_SATS()
{
    ...
    m[GPS] = {(string) "G01", (string) "G02", (string) "G03", (string) "G04", (string) "G05", (string) "G06",
              (string) "G07", (string) "G08", (string) "G09", (string) "G10", (string) "G11", (string) "G12",
              (string) "G13", (string) "G14", (string) "G15", (string) "G16", (string) "G17", (string) "G18",
              (string) "G19", (string) "G20", (string) "G21", (string) "G22", (string) "G23", (string) "G24",
              (string) "G25", (string) "G26", (string) "G27", (string) "G28", (string) "G29", (string) "G30",
    ...
    m[BDS] = {(string) "C01", (string) "C02", (string) "C03", (string) "C04", (string) "C05", (string) "C06",
              (string) "C07", (string) "C08", (string) "C09", (string) "C10", (string) "C11", (string) "C12",
              ...
              (string) "C31", (string) "C32", (string) "C33", (string) "C34", (string) "C35", (string) "C36",
              (string) "C37", (string) "C38", (string) "C39", (string) "C40", (string) "C41", (string) "C42",
              (string) "C43", (string) "C44", (string) "C45", (string) "C46", (string) "C47", (string) "C48",
              (string) "C49", (string) "C50", (string) "C56", (string) "C57", (string) "C58", (string) "C59",
              (string) "C60", (string) "C61", (string) "C62"};

    m[SBS] = {(string) "S20", (string) "S24", (string) "S25", (string) "S26", (string) "S27",
              (string) "S28", (string) "S29", (string) "S33", (string) "S35", (string) "S36",
              (string) "S37", (string) "S38", (string) "S40", (string) "S83"};

    m[QZS] = {(string) "J01", (string) "J02", (string) "J03", (string) "J04",
              (string) "J05", (string) "J06", (string) "J07"};
...
t_map_band GNSS_BAND_SORTED()
{
    ...
    m[BDS] = {BAND,   BAND_2, BAND_7, BAND_6, BAND_5,
              BAND_9, BAND_8, BAND_1}; ////  B1I  B2I(BDS-2)  B3I   B2a(BDS-3)  B2b(BDS-3)  B2(BDS-3)   B1C(BDS-3)
...
t_map_gnss GNSS_DATA_PRIORITY()
{
    ...
    m[GPS][BAND_2][TYPE_L] = {ATTR_C, ATTR_D, ATTR_S, ATTR_L, ATTR_X,   ATTR_P,
                              ATTR_W, ATTR_Y, ATTR_M, ATTR_N, ATTR_NULL};
    m[GPS][BAND_2][TYPE_D] = {ATTR_C, ATTR_D, ATTR_S, ATTR_L, ATTR_X,   ATTR_P,
                              ATTR_W, ATTR_Y, ATTR_M, ATTR_N, ATTR_NULL};
    m[GPS][BAND_2][TYPE_S] = {ATTR_C, ATTR_D, ATTR_S, ATTR_L, ATTR_X,   ATTR_P,
                              ATTR_W, ATTR_Y, ATTR_M, ATTR_N, ATTR_NULL};
