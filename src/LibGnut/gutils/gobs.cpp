...
void t_gobs::gobs2to3(GSYS sys)
{
    ...
    {
    case gnut::GPS:
        if (obs2 == L1 || obs2 == L2 || obs2 == C1 || obs2 == C2 || obs2 == D1 || obs2 == D2 || obs2 == S1 ||
            obs2 == S2)
        {
            _gattr = ATTR_C;
        }
        ...
        break;
    case gnut::GAL:
        if (obs2 == L1 || obs2 == L6 || obs2 == C1 || obs2 == C6 || obs2 == S1 || obs2 == S6 || obs2 == D1 ||
            obs2 == D6)
        {
            _gattr = ATTR_X;
        }
        else if (obs2 == L5 || obs2 == L7 || obs2 == L8 || obs2 == C5 || obs2 == C7 || obs2 == C8 || obs2 == D5 ||
                 obs2 == D7 || obs2 == D8 || obs2 == S5 || obs2 == S7 || obs2 == S8)
        {
            _gattr = ATTR_I;
        }
        else if (obs2 == P5)
    ...
    case gnut::GLO:
        ...
        break;
    case gnut::BDS:
        if (obs2 == L1 || obs2 == L7 || obs2 == C1 || obs2 == C7 || obs2 == S1 || obs2 == S7 || obs2 == D1 ||
            obs2 == D7)
        {
            _gattr = ATTR_I;
        }
