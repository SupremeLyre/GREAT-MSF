...
class LibGnut_LIBRARY_EXPORT t_gpar
{
  public:
    ...
    {
        return (tp == par_type::AMB_IF || tp == par_type::AMB13_IF || tp == par_type::AMB14_IF ||
                tp == par_type::AMB15_IF || tp == par_type::AMB_L1 || tp == par_type::AMB_L2 ||
                tp == par_type::AMB_L3 || tp == par_type::AMB_L4 || tp == par_type::AMB_L5);
    }
  ...
  protected:
    ...
    void _getmf(t_gsatdata &satData, const t_gtriple &crd, const t_gtime &epoch, double &mfw, double &mfh, double &dmfw,
                double &dmfh);
};
