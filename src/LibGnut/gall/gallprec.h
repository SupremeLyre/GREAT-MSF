...
class LibGnut_LIBRARY_EXPORT t_gallprec : public t_gallnav
{
  ...
  public:
     ...
     * @return int
     */
    int pos(const string &sat, const t_gtime &t, double xyz[3], double var[3] = NULL, double vel[3] = NULL,
     ...
     * @return int
     */
    int nav(const string &sat, const t_gtime &t, double xyz[3], double var[3] = NULL, double vel[3] = NULL,
            const bool &chk_mask = true) override;
     ...
     * @return int
     */
    int clk(const string &sat, const t_gtime &t, double *clk, double *var = NULL, double *dclk = NULL,
            const bool &chk_mask = true) override;
     ...
     * @return int
     */
    int addpos(const string &sat, const t_gtime &ep, const t_gtriple &xyz, const double &t, const t_gtriple &dxyz,
               const double &dt);
