...
void t_gallrslt::append(const string &type, const t_gtime &beg, const t_gtime &end, int idx, const string &prn,
                        double adj, double rms, double val)
{
...
{
    if ((beg < rslt.beg) || (beg == rslt.beg && end < rslt.end) ||
