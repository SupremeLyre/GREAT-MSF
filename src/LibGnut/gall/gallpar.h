...
class LibGnut_LIBRARY_EXPORT t_gallpar
{
  public:
     ...
     *@brief get parameter
     */
    int getParam(const string &site, const par_type &type, const string &prn, const t_gtime &beg = FIRST_TIME,
     ...
     *@brief get Crd Param
     */
    int getCrdParam(const string &site, t_gtriple &crd, const t_gtime &beg = FIRST_TIME,
                    const t_gtime &end = LAST_TIME) const;

    /**
     *@brief get Vel Param
     */
    int getVelParam(const string &site, t_gtriple &crd, const t_gtime &beg = FIRST_TIME,
                    const t_gtime &end = LAST_TIME) const;
