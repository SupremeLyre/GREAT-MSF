...
class LibGnut_LIBRARY_EXPORT t_gallnav : public t_gdata
{
  ...
  public:
     ...
     * @return int
     */
    virtual int nav(const string &sat, const t_gtime &t, double xyz[3] = NULL, double var[3] = NULL,
                    double vel[3] = NULL,
     ...
     * @return int
     */
    virtual int pos(const string &sat, const t_gtime &t, double xyz[3] = NULL, double var[3] = NULL,
                    double vel[3] = NULL,
                    const bool &chk_mask = true); ///< [m]
     ...
     * @return int
     */
    virtual int pos(const string &sat, const int &iod, const t_gtime &t, double xyz[3] = NULL, double var[3] = NULL,
                    double vel[3] = NULL,
     ...
     * @return    irc
     */
    virtual int clk(const string &sat, const t_gtime &t, double *clk = NULL, double *var = NULL, double *dclk = NULL,
