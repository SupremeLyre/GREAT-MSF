...
t_gnavirn::t_gnavirn()
    : t_gnav(), _iode(0), _iodc(0), _health(0), _toe(t_gtime::GPS), _toc(t_gtime::GPS), _tot(t_gtime::GPS), _a(0.0),
      ...
      _cuc(0.0), _crs(0.0), _cis(0.0), _cus(0.0), _f0(0.0), _f1(0.0), _f2(0.0), _acc(0.0)
{
...
t_gnavirn::t_gnavirn(t_spdlog spdlog)
    : t_gnav(spdlog), _iode(0), _iodc(0), _health(0), _toe(t_gtime::GPS), _toc(t_gtime::GPS), _tot(t_gtime::GPS),
      ...
      _cic(0.0), _cuc(0.0), _crs(0.0), _cis(0.0), _cus(0.0), _f0(0.0), _f1(0.0), _f2(0.0), _acc(0.0)
{
...
string t_gnavirn::line() const
{
    ...
    tmp << " " << setw(3) << sat() << " " << _toc.str("%Y-%m-%d %H:%M:%S") << scientific << setprecision(12) << setw(w)
        ...
        << _acc << setw(w) << _health / 1.0 << setw(w) << SQRT(_a) << setw(w) << _e << setw(w) << _i << setw(w) << _m
        << setw(w) << _idot << setw(w) << _omega << setw(w) << _OMG << setw(w) << _OMGDOT << setw(w) << _dn << setw(w)
        << _crc << setw(w) << _cic << setw(w) << _cuc << setw(w) << _crs << setw(w) << _cis << setw(w) << _cus
        << setw(w) << _tgd[0] << setw(w) << _tgd[1] << setw(w) << _tgd[2] << setw(w) << _tgd[3] << endl;
