...
t_geph::t_geph() : t_gdata(), _sat(""), _epoch(t_gtime::GPS), _validity(true), _gio_ptr(0)
{
    _type = EPHGPS;
}

t_geph::t_geph(t_spdlog spdlog) : t_gdata(spdlog), _sat(""), _epoch(t_gtime::GPS), _validity(true), _gio_ptr(0)
{
    _type = EPHGPS;
}
