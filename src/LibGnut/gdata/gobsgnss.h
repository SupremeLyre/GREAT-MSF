...
class LibGnut_LIBRARY_EXPORT t_gobsgnss : public t_gdata
{
  ...
  public:
    ...
    double frequency_lc(const int &band1,    // return value [Hz] of phase linear combination frequency (c1*O1 + ... )
                        ...
                        const int &band2, const double &coef2, const int &band3 = 0,
     ...
     * @return double
     */
    double pnf_lc(const int &band1, const double &coef1, const int &band2, const double &coef2, const int &band3 = 0,
     ...
     * @return double
     */
    double EWL_cycle(const t_gobs &gL1, const t_gobs &gL2, const t_gobs &gL3, const t_gobs &gC1,
  ...
  protected:
     ...
     * @return double
     */
    double _lcf_range(const t_gobs *g1, const int &cf1, const t_gobs *g2, const int &cf2, const t_gobs *g3 = 0,
                      const int &cf3 = 0) const;
     ...
     * @return double
     */
    double _lcf_phase(const t_gobs *g1, const int &cf1, const t_gobs *g2, const int &cf2, const t_gobs *g3 = 0,
                      const int &cf3 = 0) const;
     ...
     * @return double
     */
    double _lc_range(const t_gobs *g1, const double &cf1, const t_gobs *g2, const double &cf2, const t_gobs *g3 = 0,
     ...
     * @return double
     */
    double _lc_phase(const t_gobs *g1, const double &cf1, const t_gobs *g2, const double &cf2, const t_gobs *g3 = 0,
                     const double &cf3 = 0) const;
     ...
     * @return int
     */
    int _coef_multpath(const GOBSBAND &bC, double &cC, const GOBSBAND &b1, double &c1, const GOBSBAND &b2,
                       double &c2) const;
