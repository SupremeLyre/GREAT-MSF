...
t_gnavqzs::t_gnavqzs()
    : t_gnav(), _iode(0), _iodc(0), _health(0), _toe(t_gtime::GPS), _toc(t_gtime::GPS), _tot(t_gtime::GPS), _a(0.0),
      ...
      _cuc(0.0), _crs(0.0), _cis(0.0), _cus(0.0), _f0(0.0), _f1(0.0), _f2(0.0), _acc(0.0), _fit(0.0), _code(0.0),
      _flag(0.0)
{
...
t_gnavqzs::t_gnavqzs(t_spdlog spdlog)
    : t_gnav(spdlog), _iode(0), _iodc(0), _health(0), _toe(t_gtime::GPS), _toc(t_gtime::GPS), _tot(t_gtime::GPS),
      ...
      _cic(0.0), _cuc(0.0), _crs(0.0), _cis(0.0), _cus(0.0), _f0(0.0), _f1(0.0), _f2(0.0), _acc(0.0), _fit(0.0),
      _code(0.0), _flag(0.0)
{
