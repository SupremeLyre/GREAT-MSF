...
Matrix3d t_gbase::a2mat(const Vector3d &att)
{
    ...
    Matrix3d m;
    m << cy * cr - sy * sp * sr, -sy * cp, cy * sr + sy * sp * cr, sy * cr + cy * sp * sr, cy * cp,
        sy * sr - cy * sp * cr, -cp * sr, sp, cp * cr;
    return m;
}
...
Vector3d t_gbase::q2att(const t_gquat &qnb)
{
    double q11 = qnb.q0 * qnb.q0, q12 = qnb.q0 * qnb.q1, q13 = qnb.q0 * qnb.q2, q14 = qnb.q0 * qnb.q3,
           q22 = qnb.q1 * qnb.q1, q23 = qnb.q1 * qnb.q2, q24 = qnb.q1 * qnb.q3, q33 = qnb.q2 * qnb.q2,
           q34 = qnb.q2 * qnb.q3, q44 = qnb.q3 * qnb.q3;
    Vector3d att;
...
Eigen::Matrix3d great::t_gbase::dv2mat(const Eigen::Vector3d &vb1, const Eigen::Vector3d &vb2,
                                       const Eigen::Vector3d &vn1, const Eigen::Vector3d &vn2)
{
    ...
    Mb.block(0, 0, 1, 3) = vb1 / vb1.norm();
    Mn.block(0, 0, 1, 3) = vn1 / vn1.norm();
    Mb.block(0, 0, 1, 3) = vb / vb.norm();
    Mn.block(0, 0, 1, 3) = vn / vn.norm();
    Mb.block(0, 0, 1, 3) = vbb / vbb.norm();
    Mn.block(0, 0, 1, 3) = vnn / vnn.norm();
...
{
    Matrix3d vnx;
    vnx << 0, -v(2), v(1), v(2), 0, -v(0), -v(1), v(0), 0;
    return vnx;
}
...
{
    Matrix4d M;
    M << 0.0, -v(0), -v(1), -v(2), v(0), 0.0, -v(2), v(1), v(1), v(2), 0.0, -v(0), v(2), -v(1), v(0), 0.0;
    return M;
}
