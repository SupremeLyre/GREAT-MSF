...
Vector3d t_gimu::phi_cone_crt(const vector<Vector3d> &wm)
{
    ...
    if (n == 1)
        ...
        dphim = 232. / 315 * wm[2].cross(wm[3]) + 46. / 105 * wm[1].cross(wm[3]) + 18. / 35 * wm[0].cross(wm[3]) +
                178. / 315 * wm[1].cross(wm[2]) + 46. / 105 * wm[0].cross(wm[2]) + 232. / 315 * wm[0].cross(wm[1]);
    else if (n == 5)
...
Vector3d t_gimu::phi_poly_crt(const vector<Vector3d> &wm)
{
    ...
    if (n == 1)
    {
        ...
        dphim = 736. / 945 * (wm[0].cross(wm[1]) + wm[2].cross(wm[3])) +
                334. / 945 * (wm[0].cross(wm[2]) + wm[1].cross(wm[3])) + 526. / 945 * wm[0].cross(wm[3]) +
                654. / 945 * wm[1].cross(wm[2]);
    else if (n == 5)
        dphim = 123425. / 145152 * (wm[0].cross(wm[1]) + wm[3].cross(wm[4])) +
                34875. / 145152 * (wm[0].cross(wm[2]) + wm[2].cross(wm[4])) +
                90075. / 145152 * (wm[0].cross(wm[3] + wm[1].cross(wm[4]))) + 66625. / 145152 * wm[0].cross(wm[4]) +
                103950. / 145152 * (wm[1].cross(wm[2]) + wm[2].cross(wm[3])) + 55400. / 145152 * (wm[1].cross(wm[3]));
    else
        dphim = Vector3d::Zero();
    return dphim;
}
