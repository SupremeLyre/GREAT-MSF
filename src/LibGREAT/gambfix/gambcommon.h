 ...
 * @return      void
 */
LibGREAT_LIBRARY_EXPORT void getMeanFract(list<pair<double, double>> &values, double &mean, double &sigma,
                                          double &sigx);
 ...
 * @return      void
 */
LibGREAT_LIBRARY_EXPORT void getMeanWgt(bool is_edit, list<pair<double, double>> &wx, double &mean, double &sigma,
                                        double &mean_sig);
