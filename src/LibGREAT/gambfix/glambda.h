...
class LibGREAT_LIBRARY_EXPORT t_glambda
{
  public:
     ...
     * @return void
     */
    void LAMBDA4(int iMaxCan, int iN, double *pdQ, double *pdA, int *piNcan, int *piPos, double *pdCands,
     ...
     * @param[in] piMax        position in disall/cands of the vector with the largest distance of the ican vectors with
     ...
     * @return void
     */
    void STOREs(int iCan, int iPos, int *piMax, double dT, double *pdTmax, double *pdDist, double *pdDisall,
     ...
     * @return void
     */
    void COLLECTs(int iN, int iMaxCan, double dD_1, double dLef_1, double dLeft_1, double dRight_1, double dChic,
                  double *pdDist, double *pdEnd_1, int *piNcan, double *pdDisall, double *pdCands, double *pdTmax,
                  int *piMax);
     ...
     * @return void
     */
    void CHIstrt4(int iN, double *pdD, double *pdL, double *pdDist, double *pdE, double *pdA, double dTm[2],
                  double *pdT);
     ...
     * @return void
     */
    void FI71(double dChic, int iMaxCan, int iN, double *pdA, double *pdD, double *pdL, double *pdLef, double *pdLeft,
              double *pdRight, double *pdDist, double *pdEnd, double *pdDq, int *piNcan, double *pdDisall,
              double *pdCands, int *piPos);
