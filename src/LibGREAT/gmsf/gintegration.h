 ...
 */
class LibGREAT_LIBRARY_EXPORT t_gintegration : virtual public t_gsinskf, virtual public t_gpvtflt
{
  public:
    /**
     ...
     */
    explicit t_gintegration(string site, string site_base, t_gsetbase *gset, std::shared_ptr<spdlog::logger> spdlog,
                            t_gallproc *allproc);
