...
class LibGREAT_LIBRARY_EXPORT t_gattitude_model
{
  public:
    ...
    *return
        ...
        @retval =1                fail
    */
    int attitude_old(t_gsatdata &satdata, string antype, Eigen::Vector3d &i, Eigen::Vector3d &j,
    ...
    *return
        ...
        @retval =1                fail
    */
    int attitude(string antype, string prn, ColumnVector &xsat, ColumnVector &vsat, ColumnVector &xsun, ColumnVector &i,
  ...
  protected:
    ...
    */
     ...
     *param[in] k                columnVector3
     */
    void _ysm(string prn, double bata, double mi, ColumnVector &xsat, ColumnVector &vsat, ColumnVector &xsun,
     ...
     *param[in] k                columnVector3
     */
    void _onm(ColumnVector &xsat, ColumnVector &vsat, ColumnVector &xsun, ColumnVector &i, ColumnVector &j,
              ColumnVector &k);
     ...
     *param[in] k                columnVector3
     */
    void _noon_turn(string _prn, double _beta, double _mi, ColumnVector &xsat, ColumnVector &vsat, ColumnVector &xsun,
                    double R, ColumnVector &i, ColumnVector &j, ColumnVector &k);
     ...
     *param[in] k                columnVector3
     */
    void _attitude_GPSIIA(t_gsatdata &satdata, string antype, Eigen::Vector3d &i, Eigen::Vector3d &j,
                          Eigen::Vector3d &k);
     ...
     *param[in] k                columnVector3
     */
    void _attitude_GPSIIA(string antype, string prn, ColumnVector &xsat, ColumnVector &vsat, ColumnVector &xsun,
                          ColumnVector &i, ColumnVector &j, ColumnVector &k);
     ...
     *param[in] k                columnVector3
     */
    void _midnight_turn_GPSIIA(t_gsatdata &satdata, double R, Eigen::Vector3d &i, Eigen::Vector3d &j,
                               Eigen::Vector3d &k);
     ...
     *param[in] k                columnVector3
     */
    void _midnight_turn_GPSIIA(string prn, double _beta, double _mi, ColumnVector &xsat, ColumnVector &vsat,
     ...
     *param[in] k                columnVector3
     */
    void _attitude_GPSIIR(t_gsatdata &satdata, string antype, Eigen::Vector3d &i, Eigen::Vector3d &j,
                          Eigen::Vector3d &k);
     ...
     *param[in] k                columnVector3
     */
    void _attitude_GPSIIR(string antype, string prn, ColumnVector &xsat, ColumnVector &vsat, ColumnVector &xsun,
                          ColumnVector &i, ColumnVector &j, ColumnVector &k);
     ...
     *param[in] k                columnVector3
     */
    void _attitude_GPSIIRM(t_gsatdata &satdata, string antype, Eigen::Vector3d &i, Eigen::Vector3d &j,
                           Eigen::Vector3d &k);
     ...
     *param[in] k                columnVector3
     */
    void _attitude_GPSIIF(t_gsatdata &satdata, string antype, Eigen::Vector3d &i, Eigen::Vector3d &j,
                          Eigen::Vector3d &k);
     ...
     *param[in] k                columnVector3
     */
    void _attitude_GPSIIF(string antype, string prn, ColumnVector &xsat, ColumnVector &vsat, ColumnVector &xsun,
                          ColumnVector &i, ColumnVector &j, ColumnVector &k);
     ...
     *param[in] k                columnVector3
     */
    void _midnight_turn_GPSIIF(t_gsatdata &satdata, double R, Eigen::Vector3d &i, Eigen::Vector3d &j,
                               Eigen::Vector3d &k);
     ...
     *param[in] k                columnVector3
     */
    void _midnight_turn_GPSIIF(string prn, double _beta, double _mi, ColumnVector &xsat, ColumnVector &vsat,
                               ColumnVector &xsun, double R, ColumnVector &i, ColumnVector &j, ColumnVector &k);
     ...
     *param[in] k                columnVector3
     */
    void _attitude_GPSIII(t_gsatdata &satdata, string antype, Eigen::Vector3d &i, Eigen::Vector3d &j,
                          Eigen::Vector3d &k);
     ...
     *param[in] k                columnVector3
     */
    void _attitude_GPSIII(string antype, string prn, ColumnVector &xsat, ColumnVector &vsat, ColumnVector &xsun,
                          ColumnVector &i, ColumnVector &j, ColumnVector &k);
     ...
     *param[in] k                columnVector3
     */
    void _attitude_GAL1(string antype, string prn, ColumnVector &xsat, ColumnVector &vsat, ColumnVector &xsun,
                        ColumnVector &i, ColumnVector &j, ColumnVector &k);
     ...
     *param[in] k                columnVector3
     */
    void _noon_turn_GAL1(string prn, double _beta, double _mi, ColumnVector &xsat, ColumnVector &vsat,
     ...
     *param[in] k                columnVector3
     */
    void _attitude_GAL2(string antype, string prn, ColumnVector &xsat, ColumnVector &vsat, ColumnVector &xsun,
                        ColumnVector &i, ColumnVector &j, ColumnVector &k);
     ...
     *param[in] k                columnVector3
     */
    void _noon_turn_GAL2(string prn, double _beta, double _mi, ColumnVector &xsat, ColumnVector &vsat,
                         ColumnVector &xsun, ColumnVector &i, ColumnVector &j, ColumnVector &k);
     ...
     *param[in] k                columnVector3
     */
    void _cys_cast(string prn, double _beta, double _mi, ColumnVector &xsat, ColumnVector &vsat, ColumnVector &xsun,
                   ColumnVector &i, ColumnVector &j, ColumnVector &k);
     ...
     *param[in] k                columnVector3
     */
    void _cys_secm(string prn, double _beta, double _mi, ColumnVector &xsat, ColumnVector &vsat, ColumnVector &xsun,
                   ColumnVector &i, ColumnVector &j, ColumnVector &k);
     ...
     *param[in] k                columnVector3
     */
    void _attitude_BDS(string antype, string prn, ColumnVector &xsat, ColumnVector &vsat, ColumnVector &xsun,
                       ColumnVector &i, ColumnVector &j, ColumnVector &k);
     ...
     *param[in] k                columnVector3
     */
    void _cys_qzs(string prn, double _beta, double _mi, ColumnVector &xsat, ColumnVector &vsat, ColumnVector &xsun,
                  ColumnVector &i, ColumnVector &j, ColumnVector &k);
     ...
     *param[in] k                columnVector3
     */
    void _attitude_QZS(string antype, string prn, ColumnVector &xsat, ColumnVector &vsat, ColumnVector &xsun,
                       ColumnVector &i, ColumnVector &j, ColumnVector &k);
     ...
     *param[in] k                columnVector3
     */
    void _attitude_GLO(string antype, string prn, ColumnVector &xsat, ColumnVector &vsat, ColumnVector &xsun,
                       ColumnVector &i, ColumnVector &j, ColumnVector &k);
     ...
     *param[in] k                columnVector3
     */
    void _midnight_turn_GLOM(string prn, double _beta, double _mi, ColumnVector &xsat, ColumnVector &vsat,
                             ColumnVector &xsun, double R, ColumnVector &i, ColumnVector &j, ColumnVector &k);
     ...
     *param[in] k                columnVector3
     */
    void _noon_turn_GLOM(string prn, double _beta, double _mi, ColumnVector &xsat, ColumnVector &vsat,
                         ColumnVector &xsun, double R, ColumnVector &i, ColumnVector &j, ColumnVector &k);
     ...
     *param[in] k                columnVector3
     */
    void _yaw2ijk(ColumnVector &xsat, ColumnVector &vsat, ColumnVector &xsun, double &yaw, ColumnVector &i,
                  ColumnVector &j, ColumnVector &k);
