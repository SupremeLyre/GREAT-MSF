...
bool t_gbiasmodel::get_omc_obs_ALL(const t_gtime &crt_epo, t_gsatdata &obsdata, t_gallpar &pars, t_gobs &gobs,
                                   double &omc)
{
    return _omc_obs_ALL(crt_epo, obsdata, pars, gobs, omc);
}

bool t_gbiasmodel::_wgt_obs_ALL(const t_gdata::ID_TYPE &obj_type, t_gobs &gobs1, t_gsatdata &obsdata,
                                const double &factorP, double &wgt)
{
...
bool t_gbiasmodel::_Partial_basic(const t_gtime &epoch, t_gsatdata &obsdata, const t_gobs &gobs, const t_gpar &par,
                                  double &partial)
{
    partial = 0.0;
...
void t_gbiasmodel::_getmf(const t_gpar &par, t_gsatdata &satData, const t_gtriple &crd, const t_gtime &epoch,
                          double &mfw, double &mfh, double &dmfw, double &dmfh)
{
