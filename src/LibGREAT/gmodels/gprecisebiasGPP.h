...
class LibGREAT_LIBRARY_EXPORT t_gprecisebiasGPP : public t_gprecisebias
{
  public:
     ...
     */
    bool cmb_equ(t_gtime &epoch, t_gallpar &params, t_gsatdata &obsdata, t_gobs &gobs,
                 t_gbaseEquation &result) override;
     ...
     */
    bool _update_obs_info_GPP(const t_gtime &epoch, t_gallnav *nav, t_gallobj *gallobj, t_gsatdata &obsdata,
                              t_gallpar &pars);
     ...
     * @return     bool             update mode
     */
    bool _update_obj_clk_GPP(const string &obj, const t_gtime &epo, t_gallnav *nav, t_gallpar &par, double &clk,
  ...
  protected:
     ...
     */
    double cmpObs(t_gtime &epoch, string &sat, string &rec, t_gallpar &param, t_gsatdata &gsatdata,
                  t_gobs &gobs) override;
  ...
  private:
     ...
     */
    bool _prt_obs_ALL(const t_gtime &crt_epo, t_gsatdata &obsdata, t_gallpar &pars, t_gobs &gobs,
