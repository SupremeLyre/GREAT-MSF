...
class LibGREAT_LIBRARY_EXPORT t_gbiasmodel
{
  public:
     ...
     */
    virtual bool cmb_equ(t_gtime &epoch, t_gallpar &params, t_gsatdata &obsdata, t_gobs &gobs,
                         t_gbaseEquation &result) = 0;
     ...
     */
    virtual bool get_omc_obs_ALL(const t_gtime &crt_epo, t_gsatdata &obsdata, t_gallpar &pars, t_gobs &gobs,
                                 double &omc);
  ...
  protected:
     ...
     *param[in] gobs                observation data
     */
    virtual double cmpObs(t_gtime &epoch, string &sat, string &rec, t_gallpar &param, t_gsatdata &gsatdata,
                          t_gobs &gobs)
    {
        return 0.0;
    };
     ...
     *param[in] wgt                weight
     */
    bool _wgt_obs_ALL(const t_gdata::ID_TYPE &type, t_gobs &gobs1, t_gsatdata &obsdata, const double &factorP,
                      double &wgt);
     ...
     */
    bool _Partial_basic(const t_gtime &epoch, t_gsatdata &obsdata, const t_gobs &gobs, const t_gpar &par,
                        double &partial);
     ...
     *param[in] dmfh               dmfh
     */
    void _getmf(const t_gpar &par, t_gsatdata &satData, const t_gtriple &crd, const t_gtime &epoch, double &mfw,
                double &mfh, double &dmfw, double &dmfh);
