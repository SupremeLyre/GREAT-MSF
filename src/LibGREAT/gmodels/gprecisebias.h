...
class LibGREAT_LIBRARY_EXPORT t_gprecisebias : public t_gbiasmodel
{
  public:
     ...
     * @return ionoDelay
     */
    double ionoDelay(t_gtime &epoch, t_gallpar &param, t_gsatdata &satdata, IONMODEL &ion_model, GOBSBAND &band_1,
                     t_gobs &gobs);
  ...
  protected:
     ...
     * @return PCV
     */
    double PCV(bool corrt_sat, bool corrt_rec, t_gtime &epoch, t_gtime &crt_sat_epo, t_gtriple &trs_rec_crd,
     ...
     * @return Rotmatrix
     */
    Matrix _RotMatrix_Ant(t_gsatdata &obsdata, const t_gtime &receive_epoch, const t_gtime &transmit_epoch,
