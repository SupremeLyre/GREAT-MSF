...
class LibGREAT_LIBRARY_EXPORT t_gnavde : public t_gdata
{
  public:
     ...
     */
    void add_head(double SS[3], const double &au, const double &emrat, int ipt[3][13], const vector<string> &constname,
  ...
  private:
     ...
     */
    void _interp(const vector<double> &coeff, const int &ipt, const int &ncf, const int &ncm, const int &na,
