...
t_upd::t_upd(t_gsetbase *s, string version, int sz) : t_gcoder(s, version, sz), _updtype(UPDTYPE::NONE)
{
        ...
        while ((tmpsize = t_gcoder::_getline(tmp, 0)) >= 0)
        {
            ...
            if (tmp.substr(0, 1) == "%")
            {
                ...
                if (mode_tmp == "EWL" || mode_tmp == "ewl" || mode_tmp == "WL" || mode_tmp == "wl" ||
                    mode_tmp == "NL" || mode_tmp == "nl" || mode_tmp == "EWL_epoch" || mode_tmp == "ewl_epoch" ||
                    mode_tmp == "RTPPP_SAVE" || mode_tmp == "EWL24" || mode_tmp == "ewl24" || mode_tmp == "EWL25" ||
                    mode_tmp == "ewl25")
                {
